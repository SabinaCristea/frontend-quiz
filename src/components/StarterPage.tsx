        ...
        <div>
          <ul className={styles.quizesList}>
            <li
              ...
              onClick={() => dispatch({ type: "startHTML" })}
            >
              <span className={styles.htmlIcon}>
                <svg
            ...
            <li
              className={styles.listItem}
              onClick={() => dispatch({ type: "startJavaScript" })}
            >
              <span className={styles.javascriptIcon}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
                  height="40"
            ...
            >
              <span className={styles.accessibilityIcon}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
                  height="40"
