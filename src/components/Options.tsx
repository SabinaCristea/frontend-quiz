  ...
  return (
    <ol type="A" className={styles.options}>
      {options.map((option, index) => {
        const isSelected = index === options.indexOf(answer);
        ...
        return (
          <button
            ...
            ${isSelected && !hasAnswered ? styles.selected : ""}
            ${isSelected && hasAnswered && isCorrect ? styles.correct : ""}
            ${isSelected && hasAnswered && isWrong ? styles.wrong : ""}
            `}
            key={index}
          ...
          >
            ...
            {hasAnswered && isSelected && option !== correctAnswer && (
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="40"
                height="40"
